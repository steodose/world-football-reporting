...
matchday_table_ita <- ita_results2 %>% 
...
#tableau_ita <- gs4_create("matches_ita", sheets = matchday_table_ita)

# calling this will write to Googlesheets
#tableau_ita

# update data (run this every week after the games are over)
sheet_write(matchday_table_ita, ss = "https://docs.google.com/spreadsheets/d/1Ha9rcFYtwkEKGNKA8kksJkkgY2rnFGf8kTfPgidFQrI/edit#gid=872734820", 
            sheet = "matchday_table_ita")
